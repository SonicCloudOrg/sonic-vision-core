...
public class AKAZEFinder {
    ...
    public void init() {
        ...
        logger.info(total + " keypoint from tem");
    }
    ...
    public double[] find(IplImage image) {
        ...
        logger.info(total + " keypoint from img");
    ...
    public FindResult getAKAZEFindResult(File temFile, File beforeFile, boolean isDelete) {
        ...
        logger.info("Akaze spend " + spend + " ms");
        findResult.setTime(spend);
